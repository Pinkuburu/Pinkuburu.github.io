...
HTMLActuator.prototype.message = function (won) {
  ...
  mytxt[0]="= =居然连70年代你都玩过去";
  mytxt[1]="马上要开80了吧……";
  mytxt[2]="蜀风是最强的套装！不服来辩！";
  mytxt[3]="→ →女神说她最喜欢蚩灵了";
  mytxt[4]="高呼吾名！阿萨辛！";
  mytxt[5]="你死在雷神的扫射里";
  mytxt[6]="蛋总你敢下个鸡蛋么！";
  mytxt[7]="蜀风2代，只要998！";
  mytxt[8]="战宝不出大铁后，黑CD都没动力了";
  mytxt[9]="尼玛大明宫还没毕业，血战要碾压了……";
  mytxt[10]="血战还不会呢……又要开新本了";
  mytxt[11]="70的大铁我没有，但我有小铁";
  mytxt[12]="_(:3」∠)_摸都没摸过";
  mytxt[13]="不就是三千大软嘛，土豪你快买！";



  var text3 = function (m) { var r = 0; while (m > 1) r++, m >>= 1; return r; }
  var type    = won ? "game-won" : "game-over";
  var message = won ? "你摸出了<strong>沉沙玄晶</strong>" : mytxt[text3(maxscore)-3];
